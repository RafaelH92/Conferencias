...
{
	public partial class frmMecCCanaParcNovas : Form
	{
		frmMenu frmMenu;
		public frmMecCCanaParcNovas(frmMenu form)
		{
			this.frmMenu = form;
		...
		void Consultar()
		{
			try
			{
				...
				else
				{
					...
					dgvConsulta.DataSource = MecCCanaParcNova();
		...
		public List<MecCCanaParcNovas> MecCCanaParcNova() // Método que retorna a conferência dos erros 
		{
			...
			{
				var erroManu = conn.Query<MecCCanaParcNovas>(qyManu, param).ToList();
