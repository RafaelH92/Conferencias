...
{
	public partial class frmMecImpXEquip : Form
	{
		frmMenu frmMenu;
		public frmMecImpXEquip(frmMenu form)
		{
			this.frmMenu = form;
		...
		void Consultar()
		{
			try
			{
				...
				else
				{
					...
					dgvConsulta.DataSource = MecImpXEquip();
		...
		public List<MecImpXEquip> MecImpXEquip() // Método que retorna a conferência dos erros 
		{
			...
			{
				var erroMec = conn.Query<MecImpXEquip>(qyMec, param).ToList();
