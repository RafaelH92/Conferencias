...
{
	public partial class frmMecELADiversas : Form
	{
		frmMenu frmMenu;
		public frmMecELADiversas(frmMenu form)
		{
			this.frmMenu = form;
		...
		public List<MecELADiversas> MecELA() // Método que retorna a conferência dos erros 
		{
			...
			{
				var erroMec = conn.Query<MecELADiversas>(qyMac, param).ToList();
